...
REVIEW_SECTION_RE = re.compile(
    ...
    r'|추천\s*[:：]\s*\d+'                              # 추천: N
    r'|스크랩\s*[:：]\s*\d+'                            # 스크랩: N
    r'|[^\w\s가-힣a-zA-Z]{1,3}\s*\S+.*자소서'          # 🔥... 자소서 홍보 문구
    r'|(?:아쉬운점|좋은점)\s*\d+'                        # 잡코리아 편집자 태그
    r').*',
    re.DOTALL,
)
...
QUESTION_TYPE_RULES: list[tuple[str, list[str]]] = [
    ("growth", [
        "성장과정", "성장 과정", "어린 시절", "학창 시절", "유년", "성장 배경",
        "성장하게 된", "성장할 수 있었", "성장시킨", "성장의 계기",
        "나를 만든", "변화를 준", "영향을 준 사람", "인생의 전환",
    ]),
    ("motivation", [
        "지원 동기", "지원동기", "지원하게 된", "왜 지원", "관심을 갖게", "지원한 이유",
        "선택한 이유", "관심을 가지게", "이 분야를 선택",
        "회사선택 기준", "회사 선택 기준", "기업을 선택", "기업 선택",
    ]),
    ("fit", [
        "직무", "역량", "강점", "포부", "비전", "기여", "발휘",
        "직무 역량", "핵심 역량", "본인의 강점", "업무 역량",
        "역량을 갖추기 위한", "역량이 무엇이라 생각", "노력 또는 특별한 경험",
        "갖추기 위해", "역량을 기르기 위해", "이 역량을",
    ]),
    ("experience", [
        "경험", "활동", "프로젝트", "인턴", "아르바이트", "도전", "실패", "성취",
        "활동했던", "노력했던", "힘을 기르게", "기르게 되었", "창조적인",
        "합창", "동아리", "봉사", "노력한", "이겨낸", "극복한",
        "팀 활동", "협업", "갈등", "문제를 해결", "이끌었",
    ]),
    ("personality", [
        "성격", "장단점", "단점", "장점", "성향", "특기",
        "성격의 장", "자신의 장", "본인의 성격",
    ...
    ("goal", [
        "입사 후", "목표", "10년", "5년", "커리어", "미래",
        "입사하여", "입사 이후", "장기적", "단기적 목표",
    ]),
]
